...
async fn load_schema<S: Store>(_store: &S, _branch_id: &Id) -> Result<()> {
    ...
    extended_schema.classes.push(ClassDef {
        ...
        relationships: vec![],
        derived: vec![],
        domain_constraint: Domain::binary(), // Each Component instance defaults to domain [0,1]
    });
    ...
    extended_schema.classes.push(ClassDef {
        ...
        derived: vec![],
        domain_constraint: Domain::binary(), // Each Painting instance defaults to domain [0,1]
    });
    ...
    extended_schema.classes.push(ClassDef {
        ...
        relationships: vec![],
        derived: vec![],
        domain_constraint: Domain::binary(), // Each Option instance defaults to domain [0,1]
    });
    ...
    extended_schema.classes.push(ClassDef {
        ...
        derived: vec![],
        domain_constraint: Domain::binary(), // Each Car instance defaults to domain [0,1]
    });
    */
